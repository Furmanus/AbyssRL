...
import {
    ...
    START_PLAYER_TURN,
    END_PLAYER_TURN, PLAYER_ACTION_ACTIVATE_OBJECT
...
export class GameController extends Observer{
    ...
    activateObject(direction) {
        const {
            ...
            playerModel = this.playerController.getModel(),
            playerXPosition = playerModel.position.x,
            playerYPosition = playerModel.position.y,
            activatedObjectCell = this.currentLevel.getCell(playerXPosition + x, playerYPosition + y);
