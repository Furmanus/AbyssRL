...
export class MainController extends Observer{
    ...
    attachEvents(){
        ...
        window.addEventListener('keydown', this.registerKeyPressed.bind(this));  //register key pressed
        window.addEventListener('keyup', this.registerKeyReleased.bind(this)); //register key released
