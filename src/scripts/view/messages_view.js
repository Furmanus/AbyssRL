...
export class MessagesView {
    constructor (width, height) {
        this.screenElement = document.getElementById('messages');
        this.messagesListElement = document.getElementById('messagesList');
    ...
    addMessage (text, colour = 'silver', font = 'Courier new', weight = 'normal', style = 'normal') {
        ...
        */
        if(this.messagesList.length > 0) {
            ...
            let counter = this.messagesList.length - 1; // pointer to currently examined element of messagesList array.
            ...
            if(sameMessageCount > 1){
                messagesListElement.lastChild.innerText = `${messagesList[messagesList.length - 1]} x ${sameMessageCount}`;
    ...
    appendMessage (text) {
        ...
        this.messagesListElement.lastChild.innerText += ' ' + text;
        this.messagesListElement.scrollTop = this.messagesListElement.lastChild.offsetTop;
    }
    /**
