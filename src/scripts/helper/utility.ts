...
export function getDistanceBetweenPoints(pointA: Position, pointB: Position): number {
 ...
 */
export function bresenhamLine(x1: number, y1: number, x2: number, y2: number, callback: IAnyFunction): void {
 ...
 */
export function floodFill(border: ICoordinates[], startX: number, startY: number, callback: IAnyFunction): void {
    /**
 ...
 */
export function convertCoordsToDirection(coords1: ICoordinates, coords2: ICoordinates): ICoordinates {
...
export function getPositionFromString(str: string, separator: string): Position {
