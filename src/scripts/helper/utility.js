 ...
 */
export function bresenhamLine(x1, y1, x2, y2, callback){
 ...
 */
export function floodFill(border, x, y, callback){
 ...
 */
export function findCoords(array, x, y){
 ...
 */
export function convertCoordsToDirection(coords1, coords2){
 ...
 * @returns {boolean}
 */
export function isArrayEqualToArguments(array, ...args){
    let result = true;
 ...
 * @returns {boolean}
 */
export function doesArrayContainsArguments(array, ...args){
    let result = true;
...
export function getPositionFromString(string, separator) {
